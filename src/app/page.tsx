...
export default function Home() {
  return (
    <main className="min-h-screen spiritual-gradient overflow-x-hidden selection:bg-orange-200 relative">
      <div className="fixed inset-0 spiritual-pattern pointer-events-none z-0 opacity-20" />
      <OnboardingModal />
      <StreakCounter />
